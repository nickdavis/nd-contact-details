...
use NickDavis\ContactDetails\Infrastructure\{
	ServiceBasedPlugin,
...
/**
 * The ContactDetailsPlugin class is the composition root of the plugin.
 *
 ...
 */
final class ContactDetailsPlugin extends ServiceBasedPlugin {
	 ...
	 */
	protected const HOOK_PREFIX    = 'nickdavis.contact_details.';
	protected const SERVICE_PREFIX = 'nickdavis.contact_details.';
