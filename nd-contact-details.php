 ...
 *
 * @wordpress-plugin
 * Plugin Name:  ND Contact Details
 * Plugin URI:   https://github.com/nickdavis/nd-contact-details
 * Description:  WordPress plugin designed to help you manage the contact details for your website.
 * Version:      0.1.0
 * Requires PHP: 7.2
 * Author:       Nick Davis
 * Author URI:   https://iamnickdavis.com/
 * Text Domain:  nd-contact-details
 ...
 */
$plugin = ContactDetailsPluginFactory::create();
